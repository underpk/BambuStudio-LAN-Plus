...
//    });
     ...
     // OrcaSlicer calibrations
    {
        ...
        append_menu_item(flowrate_menu, wxID_ANY, _L("YOLO (Recommended)"), _L("YOLO flowrate calibration, 0.01 step"),
            [this](wxCommandEvent&) { if (m_plater) m_plater->calib_flowrate(true, 1); }, "", nullptr,
            [this]() {return m_plater->is_view3D_shown();; }, this);
        append_menu_item(flowrate_menu, wxID_ANY, _L("YOLO (perfectionist version)"), _L("YOLO flowrate calibration, 0.005 step"),
    ...
    append_menu_item(
        flowrate_menu, wxID_ANY, _L("Pass 1"), _L("Flow rate test - Pass 1"),
        [this](wxCommandEvent &) {
            if (m_plater) m_plater->calib_flowrate(false, 1);
        },
        "", nullptr,
        [this]() {
            return m_plater->is_view3D_shown();
    ...
    append_menu_item(
        ...
        [this](wxCommandEvent &) {
            if (m_plater) m_plater->calib_flowrate(false, 2);
        },
        "", nullptr,
        [this]() {
            return m_plater->is_view3D_shown();
    ...
    flowrate_menu->AppendSeparator();
    append_menu_item(
        flowrate_menu, wxID_ANY, _L("YOLO (Recommended)"), _L("YOLO flowrate calibration, 0.01 step"),
        [this](wxCommandEvent &) {
            if (m_plater) m_plater->calib_flowrate(true, 1);
        },
        "", nullptr,
        [this]() {
            return m_plater->is_view3D_shown();
        ...
        this);
    append_menu_item(
        flowrate_menu, wxID_ANY, _L("YOLO (perfectionist version)"), _L("YOLO flowrate calibration, 0.005 step"),
        [this](wxCommandEvent &) {
            if (m_plater) m_plater->calib_flowrate(true, 2);
        },
        "", nullptr,
        [this]() {
            return m_plater->is_view3D_shown();
